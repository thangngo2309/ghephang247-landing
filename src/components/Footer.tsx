    ...
    return (
      <footer id="contact" className="bg-gray-900 text-gray-300 py-10">
        <div className="max-w-6xl mx-auto px-6 md:px-0 text-center space-y-2">
          <h4 className="text-lg font-semibold text-white">CÔNG TY TNHH GIẢI PHÁP CÔNG NGHỆ HOÀNG ÂN</h4>
          <p>Địa chỉ: Đà Nẵng - Việt Nam</p>
          <p>Hotline: 19005361</p>
          <p>Email: contact@gpcnhoangan.com</p>
          <p className="text-sm text-gray-500 mt-4">© 2025 GhepHang247. All rights reserved.</p>
        </div>
      </footer>
    );
  }
